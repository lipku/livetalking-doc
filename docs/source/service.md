...
功能			|价格		|备注	 
:----				|:---		|:------	 	
基础包：<br>wav2lip高清模型 ；语音交互；同步字幕与说话开始结束事件通知；透明背景+vue代码；每个连接指定不同avatar和音色；实时音频流输入；实时切换avatar形象和动作			|¥18000		|	满足大部分大屏需求和数字人讲解功能
升级包:多个数字人同时出镜			|¥2000		|	[效果演示](https://www.bilibili.com/video/BV1FAPVzYEfC)
